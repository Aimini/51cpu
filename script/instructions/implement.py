...
[['ACC_OUT','ALU_A_DBUS_L8IN','NEXT_BYTE'],['FLASH_OUT','ALU_B_DBUS_L8IN'],['ALU_SUB','ADT_H8E','TMP_IN'],['TMP_BOP_LOAD_TMP_ZF','PSW_OUT','TMP_BOP_IDX_CY_IN','TMP_IN'],['TMP_BOP_CPL'],['BOP_OUT','PSW_LOAD_BUS'],['ALU_SUB','ADT_L8E','TMP_IN','NEXT_BYTE'],*STEP_PC_ADD_OFFSET],
#B5,   3,   CJNE,     A, direct, offset
[['ACC_OUT','ALU_A_DBUS_L8IN','NEXT_BYTE'],['FLASH_OUT','RAR_IN'],['RAM_OUT','ALU_B_DBUS_L8IN'],['ALU_SUB','ADT_H8E','TMP_IN'],['TMP_BOP_LOAD_TMP_ZF','PSW_OUT','TMP_BOP_IDX_CY_IN','TMP_IN'],['TMP_BOP_CPL'],['BOP_OUT','PSW_LOAD_BUS'],['ALU_SUB','ADT_L8E','TMP_IN','NEXT_BYTE'],*STEP_PC_ADD_OFFSET],
