...
0X11,
#32,   1,   RETI,      
[['SP_OUT','RAR_IN','ALU_A_DBUS_L8IN'],['RAM_OUT','TMP_IN'],['ALU_DEC','ALU_A_IN','RAR_IN','ADT_L8E'],['ALU_DEC','ADT_L8E','SP_IN'],['TMP_OUT','ALU_A_DBUS_H8IN'],['RAM_OUT','DTOALU','ADT_L8E','ALU_A_L8IN'],['ALU_A_OUT','ALUTOADDR','ALUADDRTE','PC_IN','INT_SVC_END']],
#33,   1,   RLC,      A
...
1,
#42,   2,   ORL,      direct, A
[*merge_first(['ACC_OUT','ALU_B_DBUS_L8IN'], STEP_DIRECT_ADDRESS),['RAM_LATCH_OUT','ALU_A_DBUS_L8IN'],['ALU_OR','ADT_L8E','RAM_IN']],
#43,   3,   ORL,      direct, #immed
[*STEP_DIRECT_ADDRESS,['RAM_LATCH_OUT','ALU_B_DBUS_L8IN','NEXT_BYTE'],['FLASH_OUT','ALU_A_DBUS_L8IN'],['ALU_OR','ADT_L8E','RAM_IN']],
#44,   2,   ORL,      A, #immed
...
0x11,
#52,   2,   ANL,      direct, A
[*merge_first(['ACC_OUT','ALU_B_DBUS_L8IN'], STEP_DIRECT_ADDRESS),['RAM_LATCH_OUT','ALU_A_DBUS_L8IN'],['ALU_AND','ADT_L8E','RAM_IN']],
#53,   3,   ANL,      direct, #immed
[*STEP_DIRECT_ADDRESS,['RAM_LATCH_OUT','ALU_B_DBUS_L8IN','NEXT_BYTE'],['FLASH_OUT','ALU_A_DBUS_L8IN'],['ALU_AND','ADT_L8E','RAM_IN']],
#54,   2,   ANL,      A, #immed
...
1,
#62,   2,   XRL,      direct, A
[*merge_first(['ACC_OUT','ALU_B_DBUS_L8IN'], STEP_DIRECT_ADDRESS),['RAM_LATCH_OUT','ALU_A_DBUS_L8IN'],['ALU_XOR','ADT_L8E','RAM_IN']],
#63,   3,   XRL,      direct, #immed
[*STEP_DIRECT_ADDRESS,['RAM_LATCH_OUT','ALU_B_DBUS_L8IN','NEXT_BYTE'],['FLASH_OUT','ALU_A_DBUS_L8IN'],['ALU_XOR','ADT_L8E','RAM_IN']],
#64,   2,   XRL,      A, #immed
...
0X11,
#B2,   2,   CPL,      bit
[['NEXT_BYTE'],['FLASH_OUT','TMP_IN'],['TMP_BITADDR_OUT','BOP_IN','RAR_IN'],['RAM_LATCH_OUT','TMP_IN'],['TMP_BOP_TMPN'],['TMP_BOP_CPL'],['BOP_OUT','RAM_IN']],
#B3,   1,   CPL,      C
...
1,
#C2,   2,   CLR,      bit
[['NEXT_BYTE'],['FLASH_OUT','TMP_IN'],['TMP_BITADDR_OUT','BOP_IN','RAR_IN'],['RAM_LATCH_OUT','TMP_IN','TMP_BOP_CLR'],['BOP_OUT','RAM_IN']],
#C3,   1,   CLR,      C
...
0x11,
#D2,   2,   SETB,     bit
[['NEXT_BYTE'],['FLASH_OUT','TMP_IN'],['TMP_BITADDR_OUT','BOP_IN','RAR_IN','TMP_BOP_CLR'],['RAM_LATCH_OUT','TMP_IN','TMP_BOP_CPL'],['BOP_OUT','RAM_IN']],
#D3,   1,   SETB,     C
...
[*STEP_DIRECT_ADDRESS,['RAM_LATCH_OUT','ALU_A_DBUS_L8IN'],['ALU_DEC','ADT_L8E','TMP_IN','RAM_IN','NEXT_BYTE'],*PC_add_off_when('PC_/ZFIN')],
#D6,   1,   XCHD,     A, @R0
